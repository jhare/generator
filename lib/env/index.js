...
var Environment = module.exports = function Environment(args, opts, adapter) {
  ...
  this.runLoop = new GroupedQueue(['initializing', 'prompting', 'configuring', 'default',
...
Environment.prototype.namespace = function namespace(filepath) {
  ...
  var rev = _.str.reverse(ns);
  ///var found = rev.match(/.*(-rotareneg(?=-rotareneg))/);
  var found = rev.match(/.*(-rotareneg)(?!\/)/);
  console.log('found is', found);
  //ns = _.str.reverse(found[0]);
